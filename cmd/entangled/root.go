...
import (
	...
	ethermintclient "github.com/Entangle-Protocol/entangle-blockchain/client"
	"github.com/Entangle-Protocol/entangle-blockchain/client/debug"
	"github.com/Entangle-Protocol/entangle-blockchain/crypto/hd"
	"github.com/Entangle-Protocol/entangle-blockchain/encoding"
	"github.com/Entangle-Protocol/entangle-blockchain/server"
	servercfg "github.com/Entangle-Protocol/entangle-blockchain/server/config"
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			// FIXME: replace AttoNGL with bond denom
			customAppTemplate, customAppConfig := servercfg.AppConfig(ethermint.AttoNGL)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		ethermintApp = app.NewEthermintApp(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts, false, baseapp.SetChainID(app.ChainID))

		if err := ethermintApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		ethermintApp = app.NewEthermintApp(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts, false, baseapp.SetChainID(app.ChainID))
	}
