...
func (suite *AnteTestSuite) TestAnteHandler() {
	...
	setup := func() {
		...
		suite.app.DistributorsAuthKeeper.SetTestingMode(true)
	}
...
func (suite *AnteTestSuite) TestAnteHandlerWithParams() {
	...
	distributorInfo := distributorsauth.DistributorInfo{
		Address: addr.Hex(),
		EndDate: 12346789123,
	}
	suite.app.DistributorsAuthKeeper.AddDistributor(suite.ctx, distributorInfo)
